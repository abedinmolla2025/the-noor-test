...
export default function NameTableRow({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "dua-card w-full text-left p-2 will-change-transform transition-all duration-300 ease-out hover:animate-[fade-in_0.42s_cubic-bezier(0.16,1,0.3,1),scale-in_0.28s_cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-[1px] hover:shadow-card hover:shadow-[0_18px_45px_-28px_hsl(var(--dua-accent)/0.55)] active:animate-[fade-in_0.42s_cubic-bezier(0.16,1,0.3,1),scale-in_0.28s_cubic-bezier(0.16,1,0.3,1)] active:translate-y-0 active:shadow-[0_14px_34px_-24px_hsl(var(--dua-accent)/0.50)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--dua-accent)/0.45)] md:p-4",
        className,
      )}
    >
